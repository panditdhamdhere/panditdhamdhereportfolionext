...
//   return (
//     <div className="fixed w-full h-20 shadow-xl z-[100] bg-blue-500">
...
//           className={
//             nav
//               ? "left-0 top-0 w-[75%] sm:w-[60%] md:w-[45%] h-screen bg-[#ecf0f3] p-10 ease-in duration-500"
//               : "left-[-100%] top-0 p-10 ease-in duration-500"
//           }
//         >
//           <div>
        ...
        >
          ...
          <div className="py-4 flex flex-col">
            <ul className="uppercase">
              ...
              <Link href="https://hashnode.com/@panditdhamdhere">
                <li onClick={() => setNav(false)} className="py-4 text-sm">
                  Blog
                </li>
              </Link>
