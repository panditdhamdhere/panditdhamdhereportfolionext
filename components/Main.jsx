      ...
      <div className="max-w-[1240px] w-full h-full mx-auto p-2 flex justify-center items-center">
        <div>
          ...
          <h1 className="py-4 text-gray-700">
            Hi, Gm Gm I&#39;m <span className="text-[#e59951]"> Pandit</span>
          </h1>
          <h1 className="py-2 text-gray-700">Passionate Blockchain Developer</h1>
          <p className="py-4 text-gray-600 sm:max-w-[70%] m-auto">
            I’m self-taught programmer, focused on building Web 3 Dapps!
          </p>
